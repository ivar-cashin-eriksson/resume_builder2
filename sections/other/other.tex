...
\cvitem{Technology}{Python (PyTorch, TensorFlow, SHAP, YOLO, OpenClip), MS Azure (Data Science Associate Certified), Databricks, AWS, MongoDB, Qdrant, Docker, 3D Printing, Fusion 360.}
